...
class Mx_parserParser(Parser):
    ...
    class NewArrayExpressionContext(ExpressionContext):
        ...
        def newpart(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(Mx_parserParser.NewpartContext)
            else:
                return self.getTypedRuleContext(Mx_parserParser.NewpartContext, i)
    ...
    class NewpartContext(ParserRuleContext):
        __slots__ = "parser"
        ...
        def getRuleIndex(self):
            return Mx_parserParser.RULE_newpart

        def enterRule(self, listener: ParseTreeListener):
            if hasattr(listener, "enterNewpart"):
                listener.enterNewpart(self)

        def exitRule(self, listener: ParseTreeListener):
            if hasattr(listener, "exitNewpart"):
                listener.exitNewpart(self)

    def newpart(self):

        localctx = Mx_parserParser.NewpartContext(self, self._ctx, self.state)
        self.enterRule(localctx, 38, self.RULE_newpart)
        self._la = 0  # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 323
